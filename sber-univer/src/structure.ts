export default [
  {
    ...
    timestamps: {
      ...
      "00:15": "glavkorp/floor1/0.jpg",
      "04:15": "glavkorp/floor1/1.jpg",
      "04:31": "glavkorp/floor1/0.jpg",
      "04:55": "glavkorp/floor1/1.jpg",
      "05:21": "glavkorp/floor1/0.jpg",
      "06:14": "glavkorp/floor1/1.jpg",
      "06:55": "glavkorp/floor1/0.jpg",
      "09:32": "glavkorp/floor1/1.jpg",
      "09:53": "glavkorp/floor1/0.jpg",
      "12:30": "glavkorp/floor1/1.jpg",
      "17:05": "glavkorp/floor1/1.jpg",
    },
    tips: {
      "00:03":
    ...
    audio: "glavkorp/floor1/001. Первый этаж.mp3",
    facts: [
    ...
    icon: "glavkorp/floor1/glavkorp.svg",
  },
  {
    id: 2,
    coords: { x: 44, y: 44 },
    ...
    timestamps: {
      ...
      "01:27": "glavkorp/floor2/1.jpg",
    },
    audio: "glavkorp/floor2/002. Второй этаж.mp3",
    facts: [
    ...
    icon: "glavkorp/floor2/glavkorp.svg",
  },
  {
    id: 3,
    coords: { x: 44, y: 44 },
    ...
    timestamps: {
      ...
      "01:01": "glavkorp/floor3/1.jpg",
      "04:42": "glavkorp/floor3/1.jpg",
    },
    audio: "glavkorp/floor3/003. Третий этаж.mp3",
    facts: [
    ...
    icon: "glavkorp/floor3/glavkorp.svg",
  },
  {
    id: 4,
    coords: { x: 44, y: 44 },
  ...
  },
  {
    ...
    audio: "guest/005. Гостиничные корпуса.mp3",
    facts: [
  ...
  },
  {
    ...
    audio: "park/007. Центральный парк.mp3",
    facts: [
  ...
  },
  {
    ...
    audio: "sport/008. Спортивный комплекс.mp3",
  ...
  },
  {
    ...
    audio: "korpcenter/floor1/009. Корпоративный центр. Первый этаж.mp3",
    facts: [
  ...
  },
  {
    ...
    audio: "korpcenter/floor2/010. Корпоративный центр. Второй этаж.mp3",
    facts: [
  ...
  },
  {
    ...
    audio: "japan/011. Японский сад.mp3",
    facts: [
